...
const Hero = () => {
  ...
  return (
    ...
    <main id="hero"  className="flex  h-screen items-center justify-center ">
      ...
      <div className=" rounded-full px-3 py-1 text-sm leading-6 text-slate-800 dark:text-slate-200 ring-1 ring-gray-900/20 dark:ring-slate-200/20 max-md:hidden">
