...
<div className="container my-12 mx-auto md:px-6 ">
  ...
  <section className='shadow-2xl' >
    <div
      className="relative max-md:w-[90%] mx-auto rounded-xl overflow-hidden bg-cover bg-no-repeat bg-[50%] bg-[url('https://mdbcdn.b-cdn.net/img/new/slides/006.webp')] h-[30vh] md:h-[60vh]">
      <div
